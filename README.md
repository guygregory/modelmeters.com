...
Model Meters provides a simple front-end to the [Azure Retail Prices API](https://docs.microsoft.com/en-us/rest/api/cost-management/retail-prices/azure-retail-prices), automatically downloading and enriching Azure AI pricing data with AI-generated summaries and insights.
...
- **[Azure Static Web Apps](https://azure.microsoft.com/en-us/services/app-service/static/)** - Static site hosting with integrated CI/CD
- **[Azure AI Foundry](https://azure.microsoft.com/en-us/products/ai-foundry/)** - AI model deployment and management platform
